...
# 보험료 실측 (KB/하나 2016-2026, 롱 온리 CAGR/샤프):
#   없음 24.9%/0.85 | 3.0 → 24회 발동, 13.8%/0.59 | 4.0 → 4회 발동, 17.5%/0.67 | 5.0 → 0회 (없음과 동일)
# 정규분포라면 |Z|>=3은 10년에 7일이어야 하지만 실측 60일. 60일 창으로 추정한 σ가 조용한 구간에서
# 작게 잡혀 그 뒤의 한 번의 움직임이 3σ가 되기 때문. 그래서 3.0은 노이즈, 5.0은 종이 위의 규칙.
HARD_STOP_Z: float | None = 4.0
COST = 0.0015  # 편도 0.15%
TRADING_DAYS = 252
