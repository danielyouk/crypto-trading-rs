...
### 1. 왜 '매 신호마다 사람이 개별 승인'하는 방식은 실패하는가?

시중의 많은 강의가 "매매 신호가 뜰 때마다 화면/메신저로 알림을 보내고 사람이 건별로 확인 버튼을 누르는 방식"을 가르칩니다. 하지만 이는 실전에서 3가지 치명적 문제를 일으킵니다.

<div class="compare-box">
  <div class="compare-card bad">
    <div class="tag">❌ 건별 개별 승인 방식의 함정</div>
    <div class="steps">
  ...
  <div class="compare-card good">
    ...
    <div class="steps">
      • <strong>주말 30분 사전 승인</strong>: 차분한 주말에 한 주의 전략 비중(Policy)을 미리 승인.<br>
      • <strong>장중 100% 무인 집행</strong>: 승인된 거래 계획에 따라 기계가 감정 없이 정해진 시간에 자동 거래.<br>
